...
<div class="vc_row wpb_row vc_row-fluid">
    <div class="wpb_column vc_column_container vc_col-sm-12">
        <div class="vc_column-inner ">
            <div class="wpb_wrapper">
                        ...
                        <div class="vc_column-inner ">
                            <div class="wpb_wrapper d-flex app-period">
                                <div class="wpb_content_element item">
                                    <div class="wpb_wrapper">
                                        <h2 class="app-period-title"><?php
											...
											<?php else: ?>Application Period: <?php echo $first_aplication_period_start . ' - ' . $first_aplication_period_finish; ?><?php endif; ?>
                                        </h2>
                                    </div>
                                </div>
								<?php if ( $application_guidelines ): ?>
                                    <div class="wpb_content_element item">
                                        <div class="wpb_wrapper pdf-guideline">
                                            <a href="<?php echo esc_url( $application_guidelines ); ?>" download
                                               class="application-guidelines-link">
                                                <img class="application-guidelines-link-image"
                                                     src="<?php echo get_stylesheet_directory_uri(); ?>/images/title-icons/pdf-icon.png"
                                                     alt="">
                                ...
                                <div class="wpb_content_element item apply-here">
                                    <div class="wpb_wrapper">
                                        <a href="#"
                                           class="vcex-button theme-button inline animate-on-hover apply-fellowship-btn">
                                            <span class="theme-button-inner">APPLY HERE</span><i
                        ...
                        <div class="vc_column-inner ">
                            <div class="wpb_wrapper">
                                <a href="/join-the-community/"
                                   class="vcex-button theme-button inline animate-on-hover join-community-btn">
                                    <span class="theme-button-inner">Join the Community</span><i
                                            class="fa fa-angle-right"></i>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="vc_column-inner ">
                            <div class="wpb_wrapper">
                                <a href="#" class="vcex-button theme-button inline animate-on-hover get-notified-btn">
                                    <span class="theme-button-inner">Get notified</span><i
                                            class="fa fa-angle-right"></i>
                                </a>
                            </div>
                        </div>
				...
				<?php if ( have_rows( 'past_fellows' ) ): ?>
                    ...
                    <span style="font-size: 18px;color: #ffffff;line-height: 38px;text-align: left; padding: 8px 12px!important;background-color: #454545!important;"
                          class="vc_custom_heading easl-recognition-award-year"><?php the_sub_field( 'year' ); ?></span>
                            ...
                            <div class="vc_empty_space" style="height: 18px"><span class="vc_empty_space_inner"></span>
                            </div>
													...
													if ( $avatar_url ):
                                                        ...
                                                        <div class="wpb_single_image wpb_content_element">
                                                            <figure class="wpb_wrapper vc_figure">
                                                                <img src="<?php echo $avatar_url; ?>" alt="" width="254"
                                                                     height="254"/>
                                                            </figure>
                                                        </div>
													<?php endif; ?>
				...
				if ( $show_more_link ):
					?>
                    <a href="<?php echo esc_url( $show_more_link['url'] ); ?>"
                       class="vcex-button theme-button inline animate-on-hover" style="background-color: #104f85">
					<span class="theme-button-inner">
						<?php
						if ( empty( $show_more_link['title'] ) ) {
							_e( 'Show more', 'total-child' );
						} else {
    ...
    font-size: 16px;
    font-weight: normal;color:#104f85;">Share this page
                                </div>
                                <div class="wpex-social-share position-horizontal style-custom display-block"
