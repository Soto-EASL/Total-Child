...
if ( function_exists( 'get_field' ) ) {
	...
	$event_application_url         = trim( get_post_meta( get_the_ID(), 'event_application_url', true ) );
                        ...
                        <div class="wpb_wrapper">
                            <div class="easl-events-top-buttons">
								<?php if ( $event_application_url ): ?>
                                    <a class="event-button event-button-wide event-button-icon event-button-icon-person event-button-apply"
                                       style="padding-top: 8px;
                                                      padding-bottom: 8px;"
                                       href="<?php echo esc_url( $event_application_url ); ?>" target="_blank">Apply</a>
								<?php else: ?>
									<?php if ( $event_submit_abstract_url ): ?>
                                        <a class="event-button event-button-wide event-button-icon event-button-icon-application"
                                           ...
                                           href="<?php echo esc_url( $event_submit_abstract_url ); ?>" target="_blank">Submit
                                            Abstract</a>
									<?php endif; ?>
									<?php if ( $event_register_url ): ?>
                                        <a class="event-button event-button-wide event-button-icon event-button-icon-person"
                                           style="padding-top: 8px;
                                                      padding-bottom: 8px;"
                                           href="<?php echo esc_url( $event_register_url ); ?>"
                    ...
                    <div class="wpb_wrapper clr">
						...
						<?php if ( $event_short_description || $event_show_more ): ?>
                            <div class="event-text-block">
								...
								<?php if ( $event_show_more ): ?>
                                    ...
                                    <p>
                                        <a href="#" class="toggle-box-button tbb-hidden"
                                           data-target="#event-more-description">
                                            <span class="tbb-shown-text">Show more <i
                                                        class="ticon ticon-angle-down"></i></span>
                            ...
                            <ul class="event-links-list">
								<?php if ( $event_online_programme_url ): ?>
                                    <li class="event-link-program" style="float: left;border: none;margin-right: 40px;">
                                        <a class="event-link-item"
                                           href="<?php echo esc_url( $event_online_programme_url ); ?>"
								...
								<?php if ( $event_notification_url && ( 'past' != $event_time_type ) ): ?>
                                    <li class="event-link-notify" style="float: left;border: none;margin-right: 40px">
                                        <a class="event-link-item"
                                           href="<?php echo esc_url( $event_notification_url ); ?>"
                                           style="display: inline-block" target="_blank">
                                            <span class="event-link-icon"><i class="ticon ticon-envelope-o"
                                                                             aria-hidden="true"></i></span>
								...
								<?php if ( $event_website_url ): ?>
                                    <li class="event-link-website" style="float: left;border: none;margin-right: 40px">
                                        <a class="event-link-item" href="<?php echo esc_url( $event_website_url ); ?>"
                                           style="display: inline-block" target="_blank">
                                            <span class="event-link-icon"><i class="ticon ticon-tv"
                                                                             aria-hidden="true"></i></span>
						...
						<?php if ( $event_accreditation ): ?>
                            ...
                            <div class="event-image-box event-image-box-border-tb">
                                ...
                                <div class="eib-text">
                                    <h3>An application has been made to the EACCME® for CME accreditation of this
                                        event.</h3>
                                </div>
                            </div>
                            <div class="event-seperator"></div>
						...
						<?php if ( $event_sponsorship_url ): ?>
                            <div class="event-sidebar-item">
                                <a class="easl-image-link" href="<?php echo esc_url( $event_sponsorship_url ); ?>">
                                    <img alt=""
                                         src="<?php echo EASL_HOME_URL; ?>/wp-content/uploads/2017/10/event-image-1.jpg"/>
						...
						<?php if ( $event_press_url ): ?>
                            <div class="event-sidebar-item">
                                <a class="easl-image-link" href="<?php echo esc_url( $event_press_url ); ?>">
                                    <img alt=""
                                         src="<?php echo EASL_HOME_URL; ?>/wp-content/uploads/2017/10/pm-thumb.jpg"/>
									...
									<?php if ( get_field( 'event_google_map_view_on_map' ) ): ?>
                                        <p>
                                            <a class="event-button event-button-icon event-button-no-arrow event-button-icon-marker event-image-box-full-button"
                                               href="<?php echo get_field( 'event_google_map_view_on_map' ); ?>"
                                               target="_blank"
                                            >View on Map</a>
                                        </p>
									<?php endif; ?>
