		...
		<?php if ( $logo_img || $overlay_logo ) : ?>
			...
			if ( $logo_img && ! $overlay_logo ) : ?>
				<a href="<?php echo esc_url( $logo_url ); ?>" title="<?php echo esc_attr( $logo_title ); ?>" rel="home" class="main-logo">
					<img src="<?php echo esc_url( $logo_img ); ?>" alt="<?php echo esc_attr( $logo_title ); ?>" class="logo-img" data-no-retina<?php echo $dims; ?> />
					<img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/images/site-logo-sticky.png" alt="<?php echo esc_attr( $logo_title ); ?>" class="logo-img-sticky" />
				</a>
			<?php endif; ?>
			<?php
			...
			if ( $overlay_logo ) : ?>
				<a href="<?php echo esc_url( $logo_url ); ?>" title="<?php echo esc_attr( $logo_title ); ?>" rel="home" class="overlay-header-logo">
					<img src="<?php echo esc_url( $overlay_logo ); ?>" alt="<?php echo esc_attr( $logo_title ); ?>" class="logo-img" data-no-retina<?php echo $dims; ?> />
					<img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/images/site-logo-sticky.png" alt="<?php echo esc_attr( $logo_title ); ?>" class="logo-img-sticky" />
				</a>
			<?php endif; ?>
		<?php else : ?>
