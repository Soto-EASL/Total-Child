...
if( !class_exists('EASL_VC_STAFF_LIST') ){
    class EASL_VC_STAFF_LIST {

        public function __construct() {
            add_shortcode( 'easl_staff_list', array( $this, 'output' ) );
            vc_lean_map( 'easl_staff_list', array( $this, 'map' ) );

            // Admin filters
            if ( is_admin() ) {

                // Get autocomplete suggestion
                add_filter( 'vc_autocomplete_easl_staff_list_include_categories_callback', 'vcex_suggest_staff_categories', 10, 1 );
                add_filter( 'vc_autocomplete_easl_staff_list_exclude_categories_callback', 'vcex_suggest_staff_categories', 10, 1 );
                add_filter( 'vc_autocomplete_easl_staff_list_filter_active_category_callback', 'vcex_suggest_staff_categories', 10, 1 );

                // Render autocomplete suggestions
                add_filter( 'vc_autocomplete_easl_staff_list_include_categories_render', 'vcex_render_staff_categories', 10, 1 );
                add_filter( 'vc_autocomplete_easl_staff_list_exclude_categories_render', 'vcex_render_staff_categories', 10, 1 );
                add_filter( 'vc_autocomplete_easl_staff_list_filter_active_category_render', 'vcex_render_staff_categories', 10, 1 );
        ...
        public function output( $atts, $content = null ) {
            ob_start();
            include( get_stylesheet_directory() . '/vc_templates/easl_staff_list.php' );
            return ob_get_clean();
        }
