...
$events_link = 'https://easl.websitestage.co.uk/events/calendar';
$publications_link = 'https://easl.websitestage.co.uk/publications';
$slide_decks_link = 'https://easl.websitestage.co.uk/slide-decks';
                ...
                <div class="easl-highlights-filter">
                    ...
                    <div class="easl-highlights-filter-dd-wrap">
                        ...
                        <ul class="easl-highlights-filter-dd">
                            ...
                            ?>
                                <li class="easl-color-<?php echo $topic_color; ?>"><a href="#" data-color="<?php echo $topic_color; ?>" data-topic="<?php echo $topic->slug; ?>"><?php echo $topic->name; ?></a></li>
                            <?php
                            endforeach;
                            ?>
                        </ul>
            ...
            <div class="easl-highlights-items">
                ...
                <div class="easl-highlights-events">
                    <h5 class="easl-highlights-item-title">
                        <?php if($events_link): ?><a href="<?php echo esc_url($events_link); ?>"><?php endif; ?>
                ...
                <div class="easl-highlights-publications">
                    <h5 class="easl-highlights-item-title">
		                <?php if($publications_link): ?><a href="<?php echo esc_url($publications_link); ?>"><?php endif; ?>
                ...
                <div class="easl-highlights-slide-decks">
                    <h5 class="easl-highlights-item-title">
		                <?php if($slide_decks_link): ?><a href="<?php echo esc_url($slide_decks_link); ?>"><?php endif; ?>
